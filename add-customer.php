...
<body class="app sidebar-mini">
                                ...
                                <form id="addcateg" method="post" action="">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="row mb-4">
                                                    <label class="col-md-3 form-label" for="Customer">Customer Name :</label>
                                                    <div class="col-md-9">
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <textarea class="form-control" name="cadd" id="cadd" placeholder="Customer Address" rows="4"></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="date" class="form-control" name="cdob" id="cdob" placeholder="Date Of Birth">
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <label class="col-md-3 form-label" for="Customer">Anniversary Date :</label>
                                                    <div class="col-md-9">
                                                        <input type="date" class="form-control" name="canndate" id="canndate" placeholder="Anniversary Date">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="number" class="form-control" name="cphoneno" id="cphoneno" placeholder="Contact No">
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <label class="col-md-3 form-label" for="Customer">Email Id :</label>
                                                    <div class="col-md-9">
                                                        <input type="email" class="form-control" name="cemail" id="cemail" placeholder="Customer Email Id">
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="cremarks" id="cremarks" placeholder="Customer Remarks">
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <button type="submit" name="submit" class="btn btn-primary" onclick="saveDataToDatabase()" style="color:white;cursor:pointer;">Add Customer</button>
                                    ...
                                    //     $cdob = $_POST["cdob"];
                                    //     $canndate = $_POST["canndate"];

                                    //     date_default_timezone_set("Asia/Calcutta");
                                    //     $postdate = date("M d,Y h:i:s a");

                                    //     $sql = "INSERT INTO customers (name,address,contactno,email,landmark,status,created,modified, dob, anniversaryDate, custRemarks) values('" . mysqli_real_escape_string($connection, $Customer) . "',
                                    //     '" . mysqli_real_escape_string($connection, $cadd) . "','" . mysqli_real_escape_string($connection, $cphoneno) . "','" . mysqli_real_escape_string($connection, $cemail) . "',
                                    //     '" . mysqli_real_escape_string($connection, $landmark) . "',
                                    //                     '" . mysqli_real_escape_string($connection, $status) . "',
                                    //                     '" . mysqli_real_escape_string($connection, $postdate) . "'
                                    //                     ,'" . mysqli_real_escape_string($connection, $postdate) . "'
                                    //                     ,'" . mysqli_real_escape_string($connection, $cdob) . "'
                                    //                     ,'" . mysqli_real_escape_string($connection, $canndate) . "'
                                    //                     ,'" . mysqli_real_escape_string($connection, $cremarks) . "')";
    ...
    <script src="add-customers.js"></script>
    <script>
