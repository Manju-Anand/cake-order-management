...
<head>
    ...
    <!--- Style css -->
    <link href="assets/css/style.css?v1=1.0.0" rel="stylesheet">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <!-- <div>
                                    ...
                                    <div class="card-title"><h2>Add New Order</h2></div>
                                </div>
                                <form id="addcateg" method="post" action="">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <input type="date" class="form-control" name="odate" id="odate" placeholder="Enter Order Date" required>
                                            </div>
                                            <div class="col-md-6 mb-4">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                <label class="col-md-12 form-label" for="Order">Additional Contact Information [ Names & Numbers ] </label>
                                                <textarea class="form-control" name="cinfo" id="cinfo" placeholder="Enter Additional Contact Information" rows="5"></textarea>
                                            ...
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <input type="date" class="form-control" name="ddate" id="ddate" placeholder="Enter Delivery Date" required>
                                                <!-- &nbsp; -->
                                                <label class="col-md-6 form-label" for="Order">Delivery Time:</label>
                                                <input type="time" class="form-control" name="dtime" id="dtime" placeholder="Enter Delivery Time" required>
                                                <!-- &nbsp; -->
                                                <label class="col-md-6 form-label" for="Order">Google Map Location <Link:touch></Link:touch>:</label>
                                                <input type="text" class="form-control" name="dgoogle" id="dgoogle" placeholder="Enter Google Map Location" required>
                                            </div>
                                            
                                            <div class="col-md-6 mb-4">
                                                <label class="col-md-13 form-label" for="Order">Additional Location </label>
                                                <textarea class="form-control" name="addlocation" id="addlocation" placeholder="Enter Additional Location Details If any" rows="7"></textarea>
                                            ...
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <input type="text" class="form-control" name="dassets" id="dassets" placeholder="Enter Description of assets supplied if any">

                                            </div>

                                            <div class="col-md-3 mb-4">
                                                <label class="col-md-6 form-label" for="Order">Check Assets:</label>
                                                <input class="form-check-input" type="radio" name="Radio" id="Radio-sm" value="Dispatched">
                                                <label class="form-check-label" for="Radio-sm">
                                                    Dispatched
                                                </label>&nbsp;&nbsp;
                                                <input class="form-check-input" type="radio" name="Radio" id="Radio-md" value="Regained">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <button type="submit" name="submit" class="btn btn-primary" onclick="saveDataToDatabase()" style="color:white;cursor:pointer;">Add Order</button>
...
<!-- ========================modals======================== -->
 <!-- Basic modal -->
    ...
    <script src="add-orders.js"></script>
    <script>
...
$(document).ready(function() {
    function calculateGST() {
        ...
        if (!isNaN(mrp) && !isNaN(qty)) {
            let taxvalue = (mrp * qty * 100) / 105;
            let gst = mrp- taxvalue;
            let total = mrp * qty;
