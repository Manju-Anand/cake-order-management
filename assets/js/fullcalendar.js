...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        select: function(arg) {
            openModal(arg.start); // Call the openModal function with the start date
    ...
    function openModal(date) {
        ...
        // Create a modal with input tags
        var modalContent = `
            <div id="myModal" class="modal">
                <div class="modal-content">
                    <span class="close" onclick="closeModal()">&times;</span>
                    <p>Event Title for ${formattedDate}:</p>
                    <input type="text" id="eventTitle" placeholder="Enter title">
    ...
    // Add the event and close the modal
    function addEvent() {
        var modal = document.getElementById("myModal");
